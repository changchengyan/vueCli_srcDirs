                    ...
                    <div class="tables">
                        <div class=" table-item ">
                            <div class="inner-wrap">
                                <div class="mainHead old"> <span>{{orgName}}安装抢修派工单</span> </div>
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="4"><span>{{oldTable.user}}</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="md">
                                            <input type="text" v-model="oldTable.attendance" placeholder="请输入出勤事由">
                                    </td>
                                        <td><span>处理人</span></td>
                                    ...
                                    <tr v-for="(item,index) in oldTable.productList" :key="index">
                                        ...
                                        <!-- <td><input v-model="item.content" :ref="'content_old'+(index+1)" type="text" placeholder="工作内容"></td>
                                        <td><input v-model="item.name" :ref="'name_old'+(index+1)" type="text" placeholder="材料名称"></td>
                                        <td><input v-model="item.unit" :ref="'unit_old'+(index+1)" type="text" placeholder="单位"></td>
                                        <td><input v-model="item.num" :ref="'num_old'+(index+1)" type="text" placeholder="数量"></td>
                                        <td class="lang"><input v-model="item.remark" :ref="'remark_old'+(index+1)" type="text" placeholder="备注"></td> -->
                            ...
                            <div class="inner-wrap">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="middle"><span>用户名</span></td>
                                        <td colspan="3"><span>{{oldTable.user}}</span></td>
                                    </tr>
                                    <tr>
                                        <td><span>紧急程度</span></td>
                                        <td colspan="2">
                        ...
                        <div class=" table-item ">
                            <div class="inner-wrap">
                                ...
                                <table>
                                    ...
                                    <!-- <tr>
                                <td><span>上报人</span></td>
                                <td><input type="text" placeholder="上报人" v-model="workOrder.reporter"></td>
                                <td><span>联系电话</span></td>
                                <td colspan="2"><input type="tel" placeholder="联系电话" v-model="workOrder.contacts"></td>
                            </tr> -->
                                    <tr>
                                        <td><span>派单人</span></td>
                                        <td>
                                ...
                                <td colspan="4"><span>{{workOrder.dangerDesc}}</span> </td>
                            </tr> -->
                                    <tr>
                                    ...
                                    <tr v-for="(item,index) in workOrder.productList" :key="index">
                                        ...
                                        <td><input v-model="item.unit"  type="text" placeholder="单位" ></td>
                                        <td><input v-model="item.number"  type="text" placeholder="数量"></td>
                                        <td class="del"><span class="btn-del" @click="workOrder_del(index)">删除</span></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class=" table-item ">
                            <div class="inner-wrap">
                                ...
                                <table>
                                    <tr>
                                        <td><span>检修地点</span></td>
                                        <td>  <span>{{workOrder.address}}</span></td>
                                        <td><span>最迟处理时间</span></td>
                                        <td >
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <!-- <input type="text" placeholder="请输入检修内容" v-model="workOrder.repireContent"> -->
                                            <span>{{workOrder.repireContent}}</span>
                                         </td>
                                    </tr>
                                    <tr>
                                        <td :rowspan="workOrder.productList.length+2"><span>材料清单</span></td>
                                    ...
                                    <tr>
                                        <td><span>派发意见</span></td>
                                        <td colspan="2"> <span>{{workOrder.orderAdvice}}</span></td>
                                    </tr>
                                    <tr class="noBorder">
                                        <td colspan="2"> <span>派发部门:{{workOrder.orderDept}}</span> </td>
...
export default {
    ...
    data() {
        return {
            ...
            tableType: 0, // 默认原有表单  0 为原有表单 1 为 标准工单
        }
    },
    methods: {
        goBack() {
        ...
        exportPdf() {
            ...
            let flag = this.tableType;
            // if (flag == 0) {
            //     let temp_oldList = this.formate_products(this.oldTable.productList);
            //     let temp_data = {
            //         orgName: this.orgName == null ? "" : this.orgName,
            //         time: this.oldTable.currentTime == null ? "" : this.oldTable.currentTime,
            ...
            // } else {
            //     let temp_oldList =this.formate_products(this.workOrder.productList);
            //     let type = this.workOrder.typeSelect;
            //     let temp_type = null;
            //     switch (type) {
            //         case "0":
            ...
            let temp_id = ''
            if(flag===0){
                temp_id = this.oldTable.id ;
            }else{
                temp_id = this.workOrder.id
            }
            this.expWorkWorder2xls_(temp_id,temp_type)
        },
        getOrderInputs() {
            let that = this;
        ...
        getOld_OrderInputs() {
            ...
            if (temp_list.length > 0) {
                for (let i = 0; i < temp_list.length; i++) {
                    ...
                    if(temp_list[i].name!==""||temp_list[i].content!==""){
                            temp_arr.push({
                            "name": "" + temp_list[i].name,
                            "unit": "" + temp_list[i].unit,
                            "num": "" + temp_list[i].number,
    ...
    created() {
        ...
        this.oldTable.tel = this.workOrder.tel = this.$store.getters.get_tel;
        this.haveDispatch = sessionStorage.getItem("haveDispatch") || "false";
        let temp_selectTableType = this.$route.params.tableType;
        this.tableType = temp_selectTableType;
        if (temp_selectTableType == 0) {
            this.msg_tabs = [{
                name: "原有工单"
            }]
            this.msg_tabItem = 0;
