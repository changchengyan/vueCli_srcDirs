<template>
    <div id="addBase">
        ...
        <save-status :showModel="ifShowModel" :content="fetchContent" @delThis="closeModel" :type="modelType" :flag="status" @sureDelThis="configDel" />
    </div>
</template>
...
<script>
    ...
    import {
        ...
        queryPointMonitor,
        updateMonitor
    } from '@/api/interfaces/pipeMonitor_api';
    ...
    // };
    // let pipeUrl = window.DSE.arcgis_belowMap;
    // 二维管网相关.
